...
export class UnidadeController {
  constructor( private listarUnidadeUseCase: ListarUnidadesUseCase, private buscarUnidadePorIDUseCase: BuscarUnidadePorIDUseCase, private deleteUnidadeUseCase: DeleteUnidadeUseCase) { }
  // /**
  //  * 
