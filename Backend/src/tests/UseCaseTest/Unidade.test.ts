...
describe("Unidade Use Cases", () => {
    let buscarUnidadePorIDUseCase: BuscarUnidadePorIDUseCase;
    let criarUnidadeUseCase: CriarUnidadeUseCase;
    let deleteUnidadeUseCase: DeleteUnidadeUseCase;
