...
describe("Disciplina Use Cases", () => {
    let criarDisciplinaUseCase: CriarDisciplinaUseCase;
    let deleteDisciplinaUseCase: DeleteDisciplinaUseCase;
    let listarDisciplinaUseCase: ListarDisciplinaUseCase;
    let listarDisciplinaPorIDUseCase: ListarDisciplinaPorIDUseCase;
    ...
    describe("CriarDisciplinaUseCase", () => {
        it("Deve criar uma nova disciplina", async () => {
            ...
            const disciplinaCriadaMock = new Disciplina(
                randomUUID(),
        ...
        it("Deve criar disciplinas de diferentes tipos corretamente", async () => {
            const disciplinas = [
                { codigo: "LP" as const, serie: "8_ANO" as const },
                { codigo: "CI" as const, serie: "6_ANO" as const },
                { codigo: "HI" as const, serie: "7_ANO" as const },
            ];
