...
const listarDisciplinaPorIDUseCase = new ListarDisciplinaPorIDUseCase(disciplinaRepository);
//Unidade Use Cases
const listarUnidadesUseCase = new ListarUnidadesUseCase(unidadeRepository, disciplinaRepository);
const listarUnidadesPorIdUseCase = new BuscarUnidadePorIDUseCase(unidadeRepository, conteudoGeradoRepository);
const deletarUnidadeUseCase = new DeleteUnidadeUseCase(unidadeRepository);
//Temas Use Cases
const sugerirTemasUseCase = new SugerirTemasUseCase(disciplinaRepository, openAIService);
//Conteúdo Use Cases
const gerarUnidadeEConteudosUseCase = new GerarUnidadeEConteudosUseCase(openAIService, unidadeRepository, disciplinaRepository, ragBnccService, conteudoGeradoRepository);
const listarConteudosUseCase = new ListarConteudosUseCase(conteudoGeradoRepository);
const atualizarConteudoUseCase = new AtualizarConteudoUseCase(conteudoGeradoRepository);
const refinarConteudoUseCase = new RefinarConteudoUseCase(conteudoGeradoRepository, unidadeRepository, openAIService);
const refinarConteudoPreviewUseCase = new RefinarConteudoPreviewUseCase(conteudoGeradoRepository, openAIService);
//Slide Use Cases
const gerarPPTXUseCase = new GerarPPTXUseCase(conteudoGeradoRepository, slideService);
const buscarPreviewSlideUseCase = new BuscarPreviewSlideUseCase(conteudoGeradoRepository);
/**
 * @Controllers
 * */
//Disciplina Controller
export const disciplinaController = new DisciplinaController(criarDisciplinaUseCase, listarDisciplinaUseCase, deletarDisciplinaUseCase, listarDisciplinaPorIDUseCase);
//Unidade Controller
export const unidadeController = new UnidadeController(listarUnidadesUseCase, listarUnidadesPorIdUseCase, deletarUnidadeUseCase);
//Temas Controller
export const temasController = new TemasController(sugerirTemasUseCase);
//Gerar Controller
export const gerarController = new GerarController(gerarUnidadeEConteudosUseCase, listarConteudosUseCase, atualizarConteudoUseCase, refinarConteudoUseCase, refinarConteudoPreviewUseCase);
//Slide Controller
export const slideController = new SlideController(gerarPPTXUseCase, buscarPreviewSlideUseCase);
